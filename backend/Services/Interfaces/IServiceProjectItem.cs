...
namespace backend.Services.Interfaces
{
    public interface IServiceProjectItem
    {
        ...
        Task<GetProjectItemDTO> CreateAsync(Int32 userId, AddProjectItemDTO projectResource);
        Task<GetProjectItemDTO> UpdateAsync(Int32 userId, Int32 id, AddProjectItemDTO projectResource);
